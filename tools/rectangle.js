artimus.tools.rectangle = {
    ...
    mouseUp: (gl, x, y, toolProperties) => {
        artimus.tools.rectangle.drawRectangle(gl, ...toolProperties.start, x, y, toolProperties);
